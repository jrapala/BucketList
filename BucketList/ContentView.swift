...
struct ContentView: View {
    ...
    // Saving to documents let you save nearly limitless amounts of data
    ...
    func saveData() {
        do {
            ...
            // .completeFileProtection encrypts files and can only be read if the used unlocks their device
